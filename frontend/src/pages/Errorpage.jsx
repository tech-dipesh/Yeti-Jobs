...
export default function Error404() {
  ...
  return (
    <div className='w-full flex flex-col overflow-x-hidden min-h-screen bg-[#1a0505]'>
      <main className='flex-1 flex flex-col items-center justify-center text-center'>
        <div className='bg-red-950 border border-red-700 rounded-2xl max-w-md w-full mb-8'>
          <div className='flex items-center justify-center gap-3 mb-5'>
            ...
            <h1 className='text-2xl font-black text-red-300 '>Something Went Wrong</h1>
              ...
              <div className='inline-flex items-center gap-2 bg-red-900 border rounded-lg p-3 font-mono text-sm text-red-300'>
                <span className='bg-red-700 text-red-100 font-bold p-x-2 py-1 rounded'>{message || statusText || 'Something Went Wrong'}</span>
              </div>
          </div>
