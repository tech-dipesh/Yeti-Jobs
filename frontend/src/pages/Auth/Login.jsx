...
import Registerleftcomps from '../../components/users/Registerleftcomps';
...
export default function Login() {
  ...
  }, [checkuser, state, checkUserError?.login, checkUserError?.verify, navigate])
    ...
    <div className='bg-slate-800/50 backdrop-blur-sm rounded-2xl border border-slate-600 p-8 shadow-xl'>
      ...
      <form onSubmit={submitForm} className='space-y-5'>
        ...
        <div>
          ...
          <PasswordInput  value={value.password} setValue={setValue} setError={setError} />
        </div>
        <button
          type='submit'
